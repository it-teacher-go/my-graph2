...
fig6 = px.scatter(df, x="first_scrn", y="total_audi", color="genre",
...
counted = (df.groupby(["nation", "genre"], as_index=False)
             .agg(편수=("movieNm", "count")))
fig7 = px.sunburst(counted, path=["nation", "genre"], values="편수")
